...
export const PupilDashboard: React.FC<PupilDashboardProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#1e293b] flex flex-col p-4 md:p-6 gap-6 font-sans" id="pupil-suite">
      ...
      <nav className="flex flex-wrap justify-between items-center bg-white p-4 rounded-2xl border border-slate-200 shadow-sm text-slate-800" id="pupil-nav">
        <Logo size="md" />
        ...
        <div className={`${isMobileMenuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row items-center gap-4 w-full md:w-auto mt-4 md:mt-0`}>
          ...
          <button
            onClick={onLogout}
            className="p-1 px-3 py-2 md:py-1 w-full md:w-auto justify-center bg-slate-900 hover:bg-slate-850 text-white font-bold text-xs rounded-xl transition flex items-center gap-1.5 cursor-pointer"
