...
export const ParentDashboard: React.FC<ParentDashboardProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#1e293b] flex flex-col p-4 md:p-6 gap-6 font-sans" id="parent-suite">
      ...
      <nav className="flex justify-between items-center bg-white p-4 rounded-2xl border border-slate-200 shadow-sm text-slate-800" id="parent-navbar">
        <Logo size="md" />
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <button
              ...
              className="p-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl text-[#065f46] relative transition cursor-pointer"
          ...
          <button
            onClick={onLogout}
            className="px-3.5 py-1.5 bg-slate-900 hover:bg-slate-850 text-white font-bold text-xs rounded-xl transition cursor-pointer"
          >
            Leave Suite
          </button>
        </div>
